...
export class AuthController {
    ...
    resendVerificationCode(@Req() req: UserRequest) {
    ...
    @ApiBearerAuth()
    @Put('verify-email')
    verifyEmail(@Req() req: UserRequest, @Body() dto: VerifyEmailDto) {
    ...
    @ApiBearerAuth()
    @Put('change-email')
    changeEmail(@Req() req: UserRequest, @Body() dto: ChangeEmailDto) {
